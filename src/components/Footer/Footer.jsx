    ...
    return(
        <>
                <div className="col-md-4 d-flex align-items-center">
                    <img className=" logo mb-3 me-2 ms-2 mb-md-0 text-body-secondary text-decoration-none lh-1" src={logo} alt="" />
                ...
                <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
                    ...
                    <li className="ms-3">
                        <a class="text-body-secondary" href="https://x.com/?lang=es">
